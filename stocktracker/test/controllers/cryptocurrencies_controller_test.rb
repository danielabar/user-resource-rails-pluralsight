...
class CryptocurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cryptocurrency" do
    assert_difference('Cryptocurrency.count') do
      post cryptocurrencies_url, params: { cryptocurrency: { name: @cryptocurrency.name, started_at: @cryptocurrency.started_at } }
    end
  ...
  test "should update cryptocurrency" do
    patch cryptocurrency_url(@cryptocurrency), params: { cryptocurrency: { name: @cryptocurrency.name, started_at: @cryptocurrency.started_at } }
